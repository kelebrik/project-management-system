...
function AppController() {
  ...
  const presentationContext = buildAppPresentationContext(derived, {
    ...
    ...{ closeOpenIssue, convertIssueToProblem, createOpenIssue, creatingIssue, expandedIssueId, issueDrawerMode, issueEditDrafts, issueForm, issueFormErrors, issueLinkDrafts, issueStatusDrafts, removeIssueFormLink, removeIssueJiraLink, saveOpenIssue, saveOpenIssueWithPayload, saveTaskJiraLink, taskDrafts, updateIssueDraft, updateIssueFormLink, updateIssueJiraLink, updateIssueStatusDraft },
