...
export function AdminSystemJiraPageContent() {
  const { saveSystemSettings, savingSystemSettings, setSystemSettingsDraft, systemSettingHasValue, systemSettings, systemSettingsDraft } = usePageContext();
  return (
	                    <article className="panel project-card">
                      <div className="panel-title">
                        <div>
