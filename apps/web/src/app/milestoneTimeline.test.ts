...
import {
  ...
  MILESTONE_PHASE_LABEL_MAX_HEIGHT,
...
test("phase milestone lane height keeps a small static gap between opposite labels", () => {
  assert.equal(
    MILESTONE_PHASE_LANE_HEIGHT + MILESTONE_PHASE_LANE_GRID_GAP,
