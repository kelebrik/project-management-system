  ...
  components: {
    ...
    schemas: {
      ...
      JiraAggregateDraft: {
        ...
        required: ["name", "description", "source", "exposedFields", "baseFilterLogic", "baseFilters", "timeZone", "sortOrder"],
      },
            ...
            content: { "application/json": { schema: {
              ...
              properties: {
                ...
                dashboard: {
                  ...
                  properties: {
                    stored: { type: "boolean" },
                    version: { type: ["integer", "null"], enum: [1, 2, 3, null] },
                    ...
                    editableConfig: { oneOf: [{ $ref: "#/components/schemas/JiraAnalyticsDashboardConfigV3" }, { type: "null" }] },
        ...
        responses: {
          "200": {
            ...
            content: { "application/json": { schema: {
              type: "object",
              properties: {
                configVersion: { type: "integer", enum: [1, 2, 3] },
                configHash: { type: "string", pattern: "^[0-9a-f]{64}$" },
          ...
          content: {
            "application/json": {
              schema: {
                ...
                additionalProperties: false,
                properties: {
                  config: { $ref: "#/components/schemas/JiraAnalyticsDashboardConfigV3" },
                  expectedConfigHash: { type: "string", pattern: "^[0-9a-f]{64}$" },
                },
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    dashboardConfig: { $ref: "#/components/schemas/JiraAnalyticsDashboardConfigV3" },
                    configHash: { type: "string", pattern: "^[0-9a-f]{64}$" },
                  },
